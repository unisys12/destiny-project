...
class DestinyBreakerTypeDefinitionSeeder extends Seeder
{
    /**
    ...
    public function run()
    {
        ...
        $table = $db->viewContentTable('DestinyBreakerTypeDefinition');
        foreach ($table as $row) {
            if ($row->redacted != true || $row->blacklisted != true) {
                DB::table('destiny_breaker_type_definitions')->insert([
