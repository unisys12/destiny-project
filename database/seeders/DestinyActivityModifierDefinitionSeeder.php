...
class DestinyActivityModifierDefinitionSeeder extends Seeder
{
    /**
    ...
    public function run()
    {
        ...
        $table = $db->viewContentTable('DestinyActivityModifierDefinition');
        foreach ($table as $row) {
            if ($row->redacted != true || $row->blacklisted != true) {
                DB::table('destiny_activity_modifier_definitions')->insert([
